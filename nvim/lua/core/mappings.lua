...
M.misc = function()
  ...
  nvim_set_keymap("n", "*", [[<Cmd>lua require("core.utils").start_search()<CR>]], { noremap = true, silent = true })
  nvim_set_keymap("v", "*", [[<Cmd>lua require("core.utils").v_start_search()<CR>]], { noremap = true, silent = true })
